...
$contenu_gauche .= '<div class="list-group">';
    ...
    // boucle while qui parcour l'objet $categorie_des_produits pour en faire un array associatif :
    while ($cat = $categories_des_produits->fetch(PDO::FETCH_ASSOC)){
        //echo '<prev>'; print_r($cat); echo '</prev>';
...
if(isset($_GET['categorie']) && $_GET['categorie'] != 'all'){
    ...
    // sinon on a demandé toutes les catégories 
