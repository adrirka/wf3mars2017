...
<!--
    ...
    - have_post(): envoi un boolean pour savoir s'il reste des objets à afficher sur la page en cours, la fonction renverra true tant que tous les articles dans la BDD n'auront pas été affichés
