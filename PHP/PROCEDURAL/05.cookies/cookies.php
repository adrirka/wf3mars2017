...
Un cookie est un petit fichier (4ko max) déposé par le server du site sur le poste de l'internaute, et qui peut contenir des informations sous forme de texte. Les cookies sont automatiquement renvoyées au server web par le navigateur lorsque l'internate navigue dans les pages concernées par les cookies
...
Précaution à prendre avec les cookies : un cookie étant sauvegardé sur le poste de l'internate, il peut être volé ou détourné. On n'y stocke donc pas de données sensibles (mots de passe, numéro de CB...)
