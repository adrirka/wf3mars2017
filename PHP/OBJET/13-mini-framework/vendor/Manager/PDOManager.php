...
// vendor/Manager/PDOManger.php

namespace Manager;
use PDO; // On récupère la classe PDO appartenant à l'espace global PHP. Sans cela nous devrions appeler comme cela : \PDO pour sortir de l'espace Manager
...
class PDOManager
{
    ...
    private function __construct(){} // la classe plus instanciable
...
//$pdo = new PDO('', '', '');
//$pdo = PDOManagber::getInstance() -> getPdo();